...
```json
{
  ...
  "input_schema": {
    ...
    "properties": {
      ...
      "max_results": {"type": "integer", "description": "search 最多返回条数，默认 5"},
      ...
      "max_depth": {"type": "integer", "description": "crawl/map 最大爬取/扫描深度"},
      "limit": {"type": "integer", "description": "crawl/map 最大页面数/URL 数"},
