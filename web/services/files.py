...
from web.services.sounds import SoundServiceMixin
...
class FileServiceMixin(SoundServiceMixin):
    ...
    @staticmethod
    def _completion_sound_media_type(data: bytes) -> str | None:
        return _completion_sound_media_type(data)

    @staticmethod
    def _play_windows_completion_sound(target: Path) -> str:
        return _play_windows_completion_sound(target)

    @staticmethod
    def _play_windows_failure_sound(target: Path) -> str:
        return _play_windows_failure_sound(target)

    @staticmethod
    def _sound_platform_system() -> str:
