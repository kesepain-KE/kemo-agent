...
def _execution_invoke(name: str, *args: Any, **kwargs: Any) -> Any:
    from plugins.shell import execution as _execution
    _execution.configure(globals())
    return _execution.invoke(name, *args, **kwargs)

def _execution_wrapper(name: str):
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        return _execution_invoke(name, *args, **kwargs)
    wrapper.__name__ = name
    wrapper.__shell_execution_wrapper__ = True
    return wrapper

_process_command = _execution_wrapper("_process_command")
_prepare_process_command = _execution_wrapper("_prepare_process_command")
_process_runtime_dependencies = _execution_wrapper("_process_runtime_dependencies")
_run_process = _execution_wrapper("_run_process")
_start_background = _execution_wrapper("_start_background")
_execute = _execution_wrapper("_execute")
