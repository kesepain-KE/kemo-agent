...
export const handlers = [
  ...
  http.get('/api/users/kesepain/sense', () => HttpResponse.json({
    ...
    core_available: true,
    core_files: 1,
    summary: { registered: 1, enabled: 1, user: 0, shared: 0, global: 1, registered_data: 1, injected_data: 1 },
    sources: [{ id: 'runtime', name: 'runtime', description: '1 个可注入 Markdown 文件', layer: 'global', enabled: true, active_for_main_agent: true, status: 'active', files: 1, registered_items: 1, injected_items: 1, data_items: ['status.md'], updated_at: 1 }],
    injection: { enabled: true, registered_items: 1, injected_items: 1, original_chars: 32, injected_chars: 32, estimated_tokens: 12, truncated: false, preview: '[runtime/status.md]\nruntime ready', preview_truncated: false, source_files: ['global_sense/runtime/status.md'], prompt_section: 'perception', prompt_position: 'System Prompt / Global Sense' },
    decisions: [],
