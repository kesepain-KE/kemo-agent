...
export function MemoryPage() {
  ...
  const weightToday = item.data?.weight_locked_today === true
  const memoryRefreshing = summary.isFetching || important.isFetching

  return <ModuleFrame className={styles.memoryPage} kicker="Memory & Lifecycle" title="记忆" description="统一展示 Web、CLI 与外部消息渠道为当前用户形成的全部记忆；渠道只作为历史来源，不隔离记忆层。" actions={<div className={styles.headerActions}>
