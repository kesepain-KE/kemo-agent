...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'agents', hydrateFallbackElement: routeFallback, lazy: async () => ({ Component: (await import('./pages/RuntimeModulesPage')).AgentsPage }) },
      ...
      { path: 'expand', hydrateFallbackElement: routeFallback, lazy: async () => ({ Component: (await import('./pages/RuntimeModulesPage')).ExpandPage }) },
      { path: 'files', hydrateFallbackElement: routeFallback, lazy: async () => ({ Component: (await import('./pages/FilesPage')).FilesPage }) },
      { path: 'messages', hydrateFallbackElement: routeFallback, lazy: async () => ({ Component: (await import('./pages/RuntimeModulesPage')).MessagesPage }) },
